...
logo_html = '<a href="index.html" style="display: flex; justify-content: center; align-items: center;"><img src="assets/logo.png" alt="Stage-Is" style="height: 40px; filter: grayscale(1);"></a>'
